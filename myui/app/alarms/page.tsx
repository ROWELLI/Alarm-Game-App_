...
export default function AlarmsPage() {
  ...
  const startAlarmSound = () => {
    ...
    if (!win.alarmAudio) {
      win.alarmAudio = new Audio("/sounds/alarm.mp3")
      win.alarmAudio.loop = true
    }

    win.alarmAudio.currentTime = 0
    win.alarmAudio.play().catch((err) => {
      ...
      <div className="max-w-md mx-auto">
        ...
        {currentTime && (
          <div className="text-center mb-6 p-3 bg-[#E8F4FD] rounded-xl">
            ...
            <p className="text-xl font-bold text-[#3B9AE8]">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="px-3 py-1 text-sm bg-[#3B9AE8] text-white rounded-lg hover:opacity-80"
                    >
                      Test
                    </button>
